...
<html lang="en">
  ...
  <body>
    <section class="h-100 w-100 bg-white" style="box-sizing: border-box">
      <div
        class="header-4-1 container-xxl mx-auto p-0 position-relative"
      ...
      >
          ...
          >
            <div class="modal-dialog" role="document">
              <div class="modal-content bg-white border-0">
                ...
                >
                  <button class="btn btn-fill text-white">Download App</button>
                </div>
              </div>
            </div>
          </div>
        ...
        <div>
          <div class="mx-auto d-flex flex-lg-row flex-column hero">
            ...
            >
              <!-- <p class="text-caption">DAPATKAN VOUCHER KPR</p> -->
              <h1 class="title-text-big">
                Dizidi Homie<br class="d-lg-block d-none" />
                Satu klik bisa punya rumah!
              </h1>
              <div
          ...
          >
            ...
            <ul class="p-0 m-0">
              <li class="list-unstyled" style="margin-bottom: 2rem">
                ...
                >
                  <span
                    class="circle text-white d-flex align-items-center justify-content-center"
                  >
                    1
                  </span>
                  Lorem Ipsum
            ...
            <button class="btn btn-learn text-white">
      ...
      >
        ...
        <div class="border-color info-footer">
          ...
          >
            ...
            >
              <p style="margin: 0">Copyright © 2022 Dizidi Homie</p>
            </nav>
          </div>
        </div>
      </div>
